    ...
    return (
      <div className="mx-auto w-full max-w-lg space-y-4 pb-12">
        <div className="rounded-lg border-2 border-rn-border-strong bg-card p-6 shadow-rn-card">
          ...
          >
            {t("overnatting.backToOvernatting")}
          </Link>
        </div>
      </div>
    );
    ...
    <div className="mx-auto w-full pb-12 md:pb-8">
      <div className={cn("overflow-hidden", RN_CARD_SHELL)}>
        <header className="flex items-center gap-3 border-b-2 border-rn-border-strong bg-card px-3 py-3 sm:gap-4 sm:px-4 md:px-5">
          <Link
            href="/app/overnatting"
            aria-label={t("overnatting.backToOvernatting")}
            className={cn(
          ...
          <div className="flex flex-col bg-card px-6 py-6 sm:px-8 sm:py-7">
            <section className="space-y-4">
              ...
              <FormSelectField
                ...
                placeholder={
                  activeUnits.length === 0 ? t("overnatting.noActiveUnits") : undefined
                }
                options={
            ...
            <div className="space-y-2">
              ...
              <FormSelectField
                ...
                id={`${rid}-customer`}
                className={cn(fieldClass, "font-medium")}
                placeholder={t("overnatting.newCustomerPlaceholder")}
            ...
            <section className="space-y-4 border-t-2 border-rn-border-strong/40 pt-6">
              <header className="space-y-1.5">
                <p className={labelClass}>{t("overnatting.timeSection")}</p>
                <p className="text-app-sm leading-snug text-muted-foreground">
                  {t("overnatting.timeSectionNewHint")}
                </p>
              </header>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label className={labelClass} htmlFor={`${rid}-checkin-t`}>
                    {t("overnatting.checkInArrival")}{" "}
                    <span className="font-normal lowercase">{t("overnatting.optional")}</span>
                  </Label>
                  <Input
                    id={`${rid}-checkin-t`}
                    type="time"
                ...
                <div className="space-y-2">
                  <Label className={labelClass} htmlFor={`${rid}-checkout-t`}>
                    {t("overnatting.checkOutDeparture")}{" "}
                    <span className="font-normal lowercase">{t("overnatting.optional")}</span>
                  </Label>
                  <Input
                    id={`${rid}-checkout-t`}
            ...
            <div className="space-y-2">
              <Label className={labelClass} htmlFor={`${rid}-price`}>
                {t("overnatting.totalPriceOptionalLabel")}
              </Label>
              <PriceInput
                id={`${rid}-price`}
                step="0.01"
