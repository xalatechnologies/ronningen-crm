  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "w-full min-w-0",
        "data-[size=default]:min-h-12 data-[size=default]:py-2.5 data-[size=default]:text-app-control",
