...
| File | Description |
|------|-------------|
| `DESIGN.md` | Design system spec — **Forest Minimalist** (YAML front matter + guidelines): colors, Manrope/Inter typography, spacing, components. |
...
- **Fonts:** Add [Manrope](https://fonts.google.com/specimen/Manrope) and keep Inter via `next/font` if you adopt this system.
